    ...
    <div className="room-showcase group grid grid-cols-1 lg:grid-cols-2 min-h-[480px]">
      ...
      >
        ...
        <div className="absolute bottom-6 left-6 lg:hidden">
          <p className="text-white font-serif text-2xl font-light">{room.name}</p>
        </div>
      </div>

      <div
        className={`flex flex-col justify-center px-8 py-12 lg:px-16 lg:py-20 ${
          reversed ? "lg:order-1 bg-warm-white" : "bg-warm-gray"
        }`}
      >
        <p className="section-label mb-4">Accommodation</p>
        <h3 className="font-serif text-3xl lg:text-4xl font-light text-charcoal mb-4 leading-tight tracking-tight">
          {room.name}
        </h3>
